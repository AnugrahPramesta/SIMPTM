        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Data Gangguan Indra Fungsional</h1>
                </div>
                            ...
                            @foreach ($datas as $data)
                                <tr style="vertical-align: middle">
                                    ...
                                    center; vertical-align: middle;">
                                        <button class="btn
                                        btn-warning"
                                            data-bs-toggle="modal" data-bs-target="#editGIF{{ $data->id }}">
                                ...
                                {{-- Modals Edit Data GIF --}}
                                <div class="modal fade" id="editGIF{{ $data->id }}" data-bs-backdrop="static"
                                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="/editGIF/{{ $data->id }}" method="post">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Data
                                                        Gangguan Indra Fungsional
                                                    </h1>
