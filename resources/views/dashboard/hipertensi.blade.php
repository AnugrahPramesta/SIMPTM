        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Data Penyakit Hipertensi</h1>
                </div>
                            ...
                            @foreach ($datas as $data)
                                <tr style="vertical-align: middle">
                                    ...
                                    center; vertical-align: middle;">
                                        <button class="btn
                                        btn-warning"
                                            data-bs-toggle="modal" data-bs-target="#editHipertensi{{ $data->id }}">
                                ...
                                {{-- Modals Edit Data Hipertensi --}}
                                <div class="modal fade" id="editHipertensi{{ $data->id }}" data-bs-backdrop="static"
                                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="/editHipertensi/{{ $data->id }}" method="post">
                                            @csrf
