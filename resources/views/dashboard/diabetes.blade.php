        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Data Penyakit Diabetes Melitus</h1>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" style="cell">
                        <thead>
                            <tr>
                                <th scope="col">No</th>
                            ...
                            @foreach ($datas as $data)
                                <tr style="vertical-align: middle">
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <button class="btn
                                        btn-warning"
                                            data-bs-toggle="modal" data-bs-target="#editDiabetes{{ $data->id }}">
                                ...
                                {{-- Modals Edit Data Diabetes --}}
                                <div class="modal fade" id="editDiabetes{{ $data->id }}" data-bs-backdrop="static"
                                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="/editDiabetes/{{ $data->id }}" method="post">
                                            @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="kecamatan_id"
                                                            ...
                                                            <option value="{{ $data->kecamatan->id }}">
