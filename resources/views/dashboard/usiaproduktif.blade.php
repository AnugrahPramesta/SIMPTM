        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Data Usia Produktif</h1>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr style="vertical-align: middle">
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        ...
                                        btn-warning"
                                            ...
                                            data-bs-target="#editUsiaProduktif{{ $data->id }}">
                                ...
                                {{-- Modals Edit Data Usia Produktif --}}
                                <div class="modal fade" id="editUsiaProduktif{{ $data->id }}"
                                    data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="/editUsiaProduktif/{{ $data->id }}" method="post">
                                            @csrf
